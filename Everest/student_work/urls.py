...
urlpatterns = [
    ...
    path("mathassignment/<int:assignment_id>/", views.submit_math_assignment, name="submit_math_assignment"),
    path("lessonassignment/<int:assignment_id>/", views.submit_lesson_assignment, name="submit_lesson_assignment"),
    ...
    path("update_lesson/<int:assignment_id>/",views.update_lesson,name="update_lesson"),
